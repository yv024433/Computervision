...
%% Input Image
close all; clear; clc
I1 = imread('cat.jpg');% input two images
I2 = imread('mouse.jpg');
...
ff2 = fft2(Igray2);
%% Smoothed Image
l=lowpassfilter([180,180],0.04,1); %call a lowpass filter set cut-off c value 0.04 and positive integer 1
...
%% Sharpened Image
h=highpassfilter([180,180],0.19,3);%call a highpass filter set cut-off c value 0.19 and positive integer 3
